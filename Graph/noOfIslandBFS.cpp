...
bool isSafe(int mat[M][N], int x, int y, int processed[M][N])
{
	return (x >= 0) && (x < M) && (y >= 0) && (y < N) &&
		(mat[x][y] && !processed[x][y]);
}

void BFS(int mat[M][N], int processed[M][N], int i, int j)
{
